...
java -jar RankLib-2.11.jar -train $dir/train_letor.txt -validate $dir/vali_letor.txt -test $dir/test_letor.txt -ranker 6 -metric2t NDCG@1 -metric2T NDCG@1 -save $dir/lmart.txt
